...
namespace Исследование_полей_и_свойств_с_помощью_рефлексии
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Для извлечения всех полей применяется метод GetFields(),
            //который возвращает массив объектов класса FieldInfo.
            ...
            //Для получения одного поля по имени применяется метод GetField(),
            //в который передается имя поля

            //рефлексия позволяет получать значения и изменять их даже у привтаных полей
            ...
            //который возвращает массив объектов PropertyInfo.
            //Для получения одного свойства по имени применяется метод GetProperty(),
