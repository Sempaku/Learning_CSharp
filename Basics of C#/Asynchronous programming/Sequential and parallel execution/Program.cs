...
namespace Последовательное_и_параллельное_выполнение
{
    internal class Program
    {
        private static async Task Main(string[] args)
        {
            ...
            //В этом случае все задачи запускаются и выполняются параллельно,
            //соответственно общее время выполнения будет меньше 6 секунд,
            //а консольный вывод программы недетерминирован
